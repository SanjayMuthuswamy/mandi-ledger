...
export function generatePDFReport(config: ReportConfig) {
  ...
  autoTable(doc, {
    ...
    alternateRowStyles: {
      fillColor: [245, 248, 250], // Very light blue-gray
    },
    styles: {
      font: 'helvetica',
      fontSize: 9,
    ...
    didDrawPage: function (data) {
      ...
      if (currentPage === pageCount) {
        doc.setFontSize(10)
        doc.setFont("helvetica", "bold")
        doc.text("Prepared By", 30, pageHeight - 20)
        doc.line(20, pageHeight - 25, 60, pageHeight - 25)
        
        doc.text("Verified By", pageWidth / 2, pageHeight - 20, { align: 'center' })
        doc.line(pageWidth / 2 - 20, pageHeight - 25, pageWidth / 2 + 20, pageHeight - 25)
        
        doc.text("Approved By", pageWidth - 30, pageHeight - 20, { align: 'right' })
      ...
      doc.text("Generated by Rice Store Management System | Confidential Business Document", 14, pageHeight - 10)
