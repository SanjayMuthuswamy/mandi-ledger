# Ledger Noir - Rice Mandi ERP & Inventory System (v1.3.2)
...
6. **Sales Management & Real-Time Invoicing:**
   ...
   * **Custom Print & Download:** Open and render print-ready tax invoices using the dedicated tax invoice template engine (`invoice.html`), loaded dynamically with real-time sales data.
...
8. **Reports Workspace:**
   ...
   * **Export PDF:** Custom jsPDF client-side exports styled as a formal ledger printout, featuring grid line layouts and automatic verification tags.
...
2. Grab the **Transaction Connection Pooler** string, usually on port `6543`.
